                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-start">
                                    ...
                                    <p class="mb-0 text-justify">Daftar sebagai Pencari Kerja dan dapatkan pekerjaan dengan mudah</p>
                                    <div class="d-flex">
                                        <a href="{{ route('registrasi') }}" class="btn bg-gradient-primary w-100 px-3 mb-2 mt-3 active me-2">Pencari Kerja</a>
                                        <a href="{{ route('registrasi.penyediaKerja') }}" class="btn w-100 px-3 mb-2 mt-3">Penyedia Kerja</a>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('registrasi.perform') }}">
                                        @csrf
                                        <input type="hidden" name="role" value="Pencari Kerja" >
                                        <div class="flex flex-col mb-3">
                                            <input type="text" name="name" class="form-control" placeholder="Nama lengkap anda" aria-label="Name" value="{{ old('name') }}" >
                        ...
                        <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                ...
                                <h4 class="text-white font-weight-bolder position-relative">Registrasi akun pencari kerja</h4>
